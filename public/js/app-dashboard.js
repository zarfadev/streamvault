    ...
    <div class="video-card" id="card-${v.id}">
      ...
      <div class="video-body">
        ...
        <div class="video-qualities">
          ...
          ${v.visibility === 'unlisted' ? `<span class="access-badge" style="background:rgba(251,191,36,.1);color:var(--amber);border:1px solid rgba(251,191,36,.2);"><svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg> No listado</span>` : ''}
        ...
        grid.innerHTML = plans.map(p => `
          <div style="background:${planColors[p.key]||'var(--surface2)'};border:1px solid ${planBorders[p.key]||'var(--border2)'};border-radius:12px;padding:18px;display:flex;flex-direction:column;gap:8px;">
            ...
            <ul style="list-style:none;display:flex;flex-direction:column;gap:4px;font-size:12px;color:var(--muted);">
              <li><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;"><polyline points="20 6 9 17 4 12"/></svg> ${p.maxVideos < 0 || p.maxVideos >= 999999 ? 'Videos ilimitados' : p.maxVideos + ' videos'}</li>
              <li><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;"><polyline points="20 6 9 17 4 12"/></svg> ${p.maxStorageGB < 0 || p.maxStorageGB >= 999999 ? 'Almacenamiento ilimitado' : p.maxStorageGB + ' GB almacenamiento'}</li>
              <li><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;"><polyline points="20 6 9 17 4 12"/></svg> ${p.maxBandwidthGB < 0 || p.maxBandwidthGB >= 999999 ? 'Bandwidth ilimitado' : p.maxBandwidthGB + ' GB/mes bandwidth'}</li>
            </ul>
